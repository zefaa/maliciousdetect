...
//            System.out.println(con.getOtherNode(getHost()).toString());
     ...
     */
    protected int checkReceiving(Message m) { // menelakukan pengecekan pada pesan ketika diterima 
        if (isTransferring()) {
 ...
 System.out.println(messages[i]+"= DropTTL");
     ...
     * Jika benar, tidak termasuk pesan yang dikirim dari pemeriksaan pesan terlama
     * (misalnya jika pesan terlama dikirim, pesan terlama kedua dikembalikan
