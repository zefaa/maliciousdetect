 ...
 */
public class DecisionEngineRouterMalicious extends ActiveRouter {
    ...
    //protected List<Message> pesanKeluar = new ArrayList<Message>();
    ...
    public DecisionEngineRouterMalicious(Settings s) {
        super(s);
    ...
    public DecisionEngineRouterMalicious(DecisionEngineRouterMalicious r) {
        super(r);
        outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
