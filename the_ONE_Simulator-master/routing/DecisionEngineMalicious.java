 ...
 * @author WINDOWS_X
 */
public class DecisionEngineMalicious extends ActiveRouter1 {
    ...
    protected RoutingDecisionEngineMalicious decider;
    ...
    public DecisionEngineMalicious(Settings s) {
        super(s);
        ...
        decider = (RoutingDecisionEngineMalicious) routeSettings.createIntializedObject(
    ...
    public DecisionEngineMalicious(DecisionEngineMalicious r) {
        super(r);
        outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
    ...
    public MessageRouter replicate() {
        return new DecisionEngineMalicious(this);
    }
...
//            }
    ...
    public void changedConnection(Connection con) {
        ...
        DecisionEngineMalicious otherRouter = (DecisionEngineMalicious) otherNode.getRouter();
        if (con.isUp()) {
    ...
    public RoutingDecisionEngineMalicious getDecisionEngine() {
        return this.decider;
    }
