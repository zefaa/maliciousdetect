 ...
 * @see Centrality
 */
public class CWindowCentrality_1 implements CentralityUas
{

    public CWindowCentrality_1(CWindowCentrality_1 aThis) {
    }
	...
	public CWindowCentrality_1(Settings s) 
	{
	...
	public CWindowCentrality_1(CWindowCentrality proto)
	{
...
//		System.out.println(this+".globalCentrality: "+this.globalCentrality+"\n");
	...
	public CentralityUas replicate()
	{
		return new CWindowCentrality_1(this);
	}
