 ...
 *
 */
public class UasBubbleRap implements RoutingDecisionEngine, CommunityDetectionEngine, InterfaceUas
{
	 ...
	 */
	public UasBubbleRap(Settings s)
	{
	 ...
	 */
	public UasBubbleRap(UasBubbleRap proto)
	{
		this.community = proto.community.replicate();
		this.centrality = (CentralityUas) proto.centrality.replicate();
	...
	public void doExchangeForNewConnection(Connection con, DTNHost peer)
	{
		...
		UasBubbleRap de = this.getOtherDecisionEngine(peer);
...
//		double time = startTimestamps.get(peer);
	...
	public boolean shouldSendMessageToHost(Message m, DTNHost otherHost, DTNHost thisHost)
	{
		...
		UasBubbleRap de = getOtherDecisionEngine(otherHost);
	...
	public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost)
	{
		...
		UasBubbleRap de = this.getOtherDecisionEngine(otherHost);
	...
	{
		UasBubbleRap de = this.getOtherDecisionEngine(hostReportingOld);
		return de.commumesWithHost(m.getTo()) && 
			!this.commumesWithHost(m.getTo());
	}
	...
	private UasBubbleRap getOtherDecisionEngine(DTNHost h)
	{
		MessageRouter otherRouter = h.getRouter();
		assert otherRouter instanceof DecisionEngineRouter : "This router only works " + 
		" with other routers of same type";
		
		return (UasBubbleRap) ((DecisionEngineRouter)otherRouter).getDecisionEngine();
	}
