...
public class TestInterface extends NetworkInterface {
     ...
     *
     * Overload this in a derived class. Check the requirements for the
     * connection to work in the derived class, then call connect(Connection,
     * NetworkInterface) for the actual connection.
     *
    ...
    /**
     * Updates the state of current connections (ie tears down connections that
     * are out of range, recalculates transmission speeds etc.).
     */
    public void update() {
