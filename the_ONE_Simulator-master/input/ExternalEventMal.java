 ...
 */
public class ExternalEventMal implements Comparable<ExternalEventMal>, Serializable {
	/** Time of the event (simulated seconds) */
	protected double time;
	
	public ExternalEventMal(double time) {
		this.time = time;
	}
	 ...
	 */
	public int compareTo(ExternalEventMal other) {
