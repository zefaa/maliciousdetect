 ...
 * be configured.
 */
public class MessageEventGeneratorDel implements EventQueue {
	 ...
	 */
	public MessageEventGeneratorDel(Settings s){
	...
	public ExternalEvent nextEvent() {
		...
		host = drawHostAddress(this.hostRange);	
		to = drawToAddress(hostRange, host);
		
		msgSize = drawMessageSize();
		interval = drawNextEventTimeDiff();
		
		/* Create event and advance to next event */
		MessageDeleteEvent mce = new MessageDeleteEvent(host,this.getID(), 
				 this.nextEventsTime, true);
